...
import com.microservice.gateway.configuration.filter.JwtFilterValidator;
import com.microservice.gateway.domain.services.UserDetailsServiceImpl;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception{
        return httpSecurity.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(authorization->
                    authorization.requestMatchers(HttpMethod.GET,"/api/**").hasAuthority("READ")
