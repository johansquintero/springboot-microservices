...
public class CourseController {
    ...
    @GetMapping(path = "/search-by-values/{value}")
    public ResponseEntity<List<CourseDto>> getByName(@PathVariable(name = "value") String value) {
        return ResponseEntity.ok(this.courseService.getCoursesByValue(value));
    }
